...
#
# Generated by export_simulation on Thu Oct 05 09:51:50 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_0_gpio.sh' script.

./clk_wiz_0_gpio.sh -reset_run
...
./clk_wiz_0_gpio.sh -noclean_files

For more information on the script, please type './clk_wiz_0_gpio.sh -help'.
